...
type AddressFunc func(context.Context, *gen.AddressMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f AddressFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	mv, ok := m.(*gen.AddressMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.AddressMutation", m)
	}
	return f(ctx, mv)
}
