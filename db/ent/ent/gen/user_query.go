...
func (uq *UserQuery) loadAddresses(ctx context.Context, query *AddressQuery, nodes []*User, init func(*User), assign func(*User, *Address)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.AddressesTable)
		s.Join(joinT).On(s.C(address.FieldID), joinT.C(user.AddressesPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(user.AddressesPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.AddressesPrimaryKey[1]))
